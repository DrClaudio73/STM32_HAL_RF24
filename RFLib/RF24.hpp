...
public:
     ...
     */
    // Original: RF24(uint16_t _cepin, uint16_t _cspin, uint32_t _spispeed = RF24_SPI_SPEED);
    RF24(GPIO_TypeDef *_ce_port, uint16_t _cepin, GPIO_TypeDef *_csn_port, uint16_t _cspin, uint32_t _spi_speed = RF24_SPI_SPEED); //mio
