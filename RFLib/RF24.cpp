...
/****************************************************************************/
uint8_t RF24::print(char* formato, char* testo){

	uartRF24.print(formato, testo);
	return 0;
}
...
bool RF24::begin(void)
{
      ...
      // Initialize pins
      if (ce_pin != csn_pin) {
        //pinModeRF24(ce_port,ce_pin, OUTPUT);
        //pinModeRF24(csn_port,csn_pin, OUTPUT);
        pinModeRF24_ce_csn();
      }
      timerRF24.begin();
      uartRF24.begin();
      char formato[]="%s\r\n";
      char testo[]="Ciao uart e timer inizializzati";
      uartRF24.print(formato, testo);
      _SPI.begin();
      ce(LOW);
      csn(HIGH);
...
void RF24::delayMicroseconds(uint16_t us){
	timerRF24.setCNT(1); //da mettere come .setCNT(0)
